...
*pairs, it tracks a counter for each key. It starts empty. Each time counters_add is 
*called on a given key, that key’s counter is incremented. The current counter value can 
*be retrieved by asking for the relevant key.
*
